	...
	<section id="about">
		<div class="container mb-50">
			<div class="card shadow">
				<div class="card-body">
					<h2>Buat Event</h2>
					<small>Buat eventmu semenarik mungkin yaks ^_^</small>
						...
						<div class="row justify-content-center my-3">
							...
							<div class="col-md-6">
                                <div class="my-2">
                                    ...
                                    <img id="showingImage" src="#" alt="masukan gambar event"/> <br> <br>
                                    <input type="file" name="image" value="<?= $image; ?>" onchange="showImage(this);" accept="image/*" required/> <br>
