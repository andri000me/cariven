...
<?php
        ...
        $dateCreated = date("Y-m-d", strtotime($latest->news_created));
    ?>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="blog_left_sidebar">
					...
					<h5>Tidak ada artikel dengan kata kunci <strong>"<?= $_GET['v'] ?>"</strong> </h5>
					<?php else: ?>
					<h5>Hasil pencarian untuk kata kunci <strong>"<?= $_GET['v'] ?>"</strong> </h5>
